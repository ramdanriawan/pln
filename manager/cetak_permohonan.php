	...
	while($b=mysql_fetch_array($query)){
		...
		<tr>
			...
			<td>		
				...
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus_permohonan.php?no_permohonan=<?php echo $b['no_permohonan']; ?>&nama=<?php echo $b['nama'] ?>&bagian=<?php echo $b['bagian']; ?>' }" class="btn btn-danger">Hapus</a>
			</td>
		</tr>
