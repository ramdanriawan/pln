				...
				<div class="modal-body">				
					<form action="bbm_act.php" method="post">
						...
						<div class="form-group">
							...
							<input name="harga" type="text" id="harga" class="form-control" placeholder="harga" required="" autocomplete="off" onkeypress='return isNumberKeyTrue(event)' onPaste='false'>
						</div>	
						<div class="form-group">
							<label>Total Pembelian (Rupiah) </label>
							<input type="text" name="total" id="total" class="form-control" placeholder="total" required="" autocomplete="off" onkeypress='return isNumberKeyTrue(event)' onPaste='false'>
						</div>	
						<div class="form-group">
							<label>Stand KM</label>
							<input name="stand_km" type="text" class="form-control" placeholder="stand km" required="" autocomplete="off" onkeypress='return isNumberKeyTrue(event)' onPaste='false'>
						</div>	
						<div class="form-group">
							<label>Sopir</label>								
						...
						<div class="form-group">
							...
							<select class="form-control" name="jenis_bbm" onkeyup="this.value = this.value.toUpperCase()">
						...
						<div class="form-group">
							...
							<input name="lokasi_beli" type="text" class="form-control" placeholder="lokasi beli" required="" autocomplete="off" onkeyup="this.value = this.value.toUpperCase()">
						</div>
						<div class="form-group">
							<label> Tanggal Beli </label>
							<input name="tgl_transaksi" type="text" class="form-control" id="tgl_transaksi" required="" autocomplete="off">
						</div>
