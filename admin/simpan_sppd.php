...
$sql = "insert into tb_sppd(no_permohonan, driver, tanggal_pergi, tanggal_kembali, biaya_harian, biaya_penginapan,total,no_pol) 
...
$sql = "update tb_permohonan set `type` = 'SPPD', `no_pol` = '$no_pol' where no_permohonan = ".$no_permohonan;
mysql_query($sql) or die(mysql_error());
