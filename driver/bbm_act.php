...
mysql_query("insert into tb_bbm values('$no_permohonan','$tgl_transaksi','$no_kendaraan','$pembagian','$harga','$total','$stand_km','$sopir','$besarbbm','$lokasi_beli','$tgl_entry')")or die(mysql_error());
