...
include 'header.php';
?>
<h3><span class="glyphicon glyphicon-briefcase"></span>  DETAIL SEWA</h3>
<div class="text-left">
	<a href="cetak_permohonan.php" class="btn btn-default btn-xs">Back</a>
</div>
<?php
$q = mysql_query("select * from tb_sewa where no_permohonan = ".$_GET['no_permohonan']);
if($q){
...
.table-borderless tfoot tr td {
	...
	<table class="table table-borderless">
		...
		<tr>
			<td>Tanggal Pergi</td>
			<td><?php echo $data['tanggal_pergi']?></td>
		</tr>
		<tr>
