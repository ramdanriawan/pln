...
$sql = "insert into tb_sewa(no_permohonan, nama_sopir, tanggal_pergi, tanggal_kembali,no_pol) 
values('$no_permohonan','$nama_sopir','$tanggal_pergi','$tanggal_kembali','$no_pol')";
